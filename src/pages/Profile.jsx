...
export function Profile({navigation}) {
  ...
  if (profile !== '{}' || typeof profile != 'undefined') {
    ...
    const changePin = async value => {
      ...
      Alert.alert(
        '¡Hecho!',
        `Se ha ${change_type} correctamente el PIN.`,
        [{text: 'OK'}],
        {
          cancelable: true,
        },
    ...
    const invalidPin = async value => {
      ...
      if (isNaN(getValues().pin)) {
        Alert.alert(
          '¡Ups!',
          'El PIN debe ser un número de 4 cifras.',
          [{text: 'OK'}],
          {
            cancelable: true,
          },
        ...
        Alert.alert('¡Ups!', 'El PIN debe coincidir.', [{text: 'OK'}], {
          cancelable: true,
        });
      } else {
        Alert.alert('¡Ups!', 'PIN inválido', [{text: 'OK'}], {
          cancelable: true,
        });
      }
    };
    ...
    const deletePIN = async () => {
      ...
      Alert.alert('¡Aviso!', 'Ahora tu cuenta no tiene PIN.', [{text: 'OK'}], {
        cancelable: true,
      });
    };
    ...
    const deletePinButton = (
      <View style={{flexDirection: 'row', marginTop: dp(20)}}>
        <Button
          img={require('../../assets/open_lock.png')}
          color={palette.gray}
          onPress={() => deletePIN()}
          label="Eliminar PIN"
        />
      ...
      <ScrollView
        ...
        <Modal
          ...
          <View style={styles.modalView}>
            ...
            />
            <Text style={modalStyles.modalText}>
              Esto eliminará el usuario. ¿Desea continuar?
            </Text>
        ...
        <View style={[styles.container, {alignItems: 'center'}]}>
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <Button
                img={require('../../assets/user_icon.png')}
                color={palette.violet}
                onPress={() => openChange('name')}
            ...
            <View style={{flexDirection: 'row', marginTop: dp(20)}}>
              <Button
                ...
                color={palette.violet}
                onPress={() => openChange('pin')}
                label={
                  activeProfile.pin == '0' || activeProfile.pin == undefined
                    ? 'Añadir PIN'
                    : 'Cambiar PIN'
                }
              />
