  ...
  return (
    <View style={[styles.container, {flexDirection: 'column', padding: 0}]}>
      <View style={[styles.container, {flexDirection: 'row', padding: 0}]}>
        <TouchableOpacity style={[styles.button, {backgroundColor: palette.red, borderEndWidth: 2.5, borderBottomWidth: 2.5}]} onPress={onPressFQA}>
          <View style={styles.button_container}>
            <Text style={styles.button_text}>Dudas</Text>
            <Image source={require('../../assets/fqa_icon.png')} resizeMode='contain' style={{flex: 1, marginBottom: 80}} />
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.button, {backgroundColor: palette.red, borderLeftWidth: 2.5, borderBottomWidth: 2.5}]} onPress={onPressContact}>
          <View style={styles.button_container}>
